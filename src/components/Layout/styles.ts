...
export const Layout = styled(BaseLayout)`
  ...
  @media (min-width: ${({ theme }) => theme.breakpoint.mobile} and max-width: ${({ theme }) => theme.breakpoint.desktop}) {
    ${({ theme }) =>
      css`
        grid-template-columns:
          minmax(0, calc(100% - ${theme.size.sidebarWidthMobile} - ${theme.size.layoutGutter}))
          0 auto;
      `}
  }

  @media (min-width: ${({ theme }) => theme.breakpoint.tablet} and max-width: ${({ theme }) => theme.breakpoint.desktop}) {
    ${({ theme }) =>
      css`
        grid-template-columns:
          minmax(0, calc(100% - ${theme.size.sidebarWidthTablet} - ${theme.size.layoutGutter}))
          0 auto;
      `}
  }
  ...
  @media (min-width: ${({ theme }) => theme.breakpoint.desktop}) {
    ${({ theme }) =>
      css`
        grid-template-columns:
          minmax(0, calc(100% - ${theme.size.sidebarWidthDesktop} - ${theme.size.layoutGutter}))
          0 auto;
      `}
  }
`
